...
function Remaining() {
  ...
  return (
    ...
    <div className='w-full md:w-1/3 mt-6 p-6 rounded-md bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300 flex flex-col border space-y-3'>
        ...
        <h2 className='font-semibold text-lg bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300'>This part is in progress. We will release this feature soon.</h2>
