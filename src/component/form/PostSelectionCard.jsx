...
function PostSelectionCard() {
  ...
  const [negMark1, setNegMark1] = useState(0.25);
  const [negMark2, setNegMark2] = useState(0.5);
  ...
  return (
    <div className="w-full flex justify-center items-center px-4 py-8">
      <Navbar/>
      {/* Main Card */}
      <div className="w-full max-w-2xl rounded-2xl shadow-xl p-6 sm:p-10 flex flex-col gap-6
